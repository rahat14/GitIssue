...
import com.syntext.error.gitissue.ui.screen.projectScreen.screens.repoIssueList.RepoIssueViewmodel
...
val appModule = module {
    ...
    viewModel { ProjectSummaryViewmodel(get()) }
    viewModel { RepoIssueViewmodel(get()) }
}